...
export default function KeywordArea({ Query, setQuery }){
  ...
  return (
    <S.Flex>
      <S.Search>
        <S.Input placeholder="음식점 이름 입력(4자 이상)" value={input} onChange={e => setInput(e.target.value)} onKeyPress={onKeyPress} />
