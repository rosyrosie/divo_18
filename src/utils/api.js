...
export const USER_TOGGLE_URL = BASE_URL + 'model/userSetting/toggle?email=';
...
export const GROWTH_URL = (scale, type, start, display, regionCode) => BASE_URL + 'map/bound/system/trend?scale=' + scale + '&type=' + type + '&start=' + start + '&display=' + display + '&regionCode=' + regionCode;